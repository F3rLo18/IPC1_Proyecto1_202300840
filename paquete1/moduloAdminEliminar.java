...
public class moduloAdminEliminar extends JFrame{
    ...
    private void iniciarEtiquetas(){
        JLabel etiquetaEditar= new JLabel("Eliminar investigador");
    ...
    private void crearListenerEliminar(JButton boton, JTextField cajaCodigo){
        ActionListener oyente = new ActionListener() {
            ...
            ListaInvestigadores.listaInvestigadores.remove(ListaInvestigadores.listaInvestigadores.get(ListaInvestigadores.obtenerPosicion(cajaCodigo.getText())));
            ListaInvestigadores.regenerarCSV();
            JOptionPane.showMessageDialog(null, "El investigador ha sido borrado con éxito");
            }
            else{
                JOptionPane.showMessageDialog(null, "No existe el investigador con el codigo ingresado...");
            }   
            }
